...
class _NewExpenseState extends State<NewExpense> {
  ...
  void _presentDatePicker() async {
    ...
    //The below will be executed only after await
    setState(() {
  ...
  void _showDialog() {
    // dart:io is used for checking platform
    if (Platform.isIOS) {
      showCupertinoDialog(
        context: context,
      ...
      return SizedBox(
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                if (width >= 600) // NOTE: no curly braces here
                  Row(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              ...
                              //! forces dart to assume the value won't be null
                            ),
                            IconButton(
